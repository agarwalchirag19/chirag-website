                ...
                <div class="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
                  ...
                  <div class="flex relative pb-12">
                    ...
                    <div class="flex-grow pl-4">
                      ...
                      <p class="leading-relaxed">
                        Connect your Metamask account as you won't be able to
                        use mining feature whitout connecting to metamask .
                      </p>
                    </div>
                  </div>
                  <div class="flex relative pb-12">
                    ...
                    <div class="flex-grow pl-4">
                      ...
                      <p class="leading-relaxed">
                        Explore the page and find the services according to your
                        needs .
                      </p>
                    </div>
                  </div>
